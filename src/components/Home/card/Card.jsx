      ...
      <div className="flex flex-wrap justify-center rounded-xl gap-10">
        {Product?.slice(20, 32).map((e, idx) => (
          ...
          >
            ...
            <button className=" btn bg-amber-600 hover: text-white border-2 border-amber-500 hover:bg-transparent hover:text-amber-500 text-xl hover:border-amber-600 mx-auto w-fit flex justify-center mb-5 rounded-xl p-1">
              Order{" "}
            </button>
          </div>
        ))}
