    ...
    <React.Fragment>
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-1/2 mx-auto flex w-11/12 max-w-[1200px] -translate-x-1/2 -translate-y-1/2 flex-col text-center text-white lg:ml-5">
          <h1 className="text-4xl font-bold sm:text-5xl lg:text-left">HAVIT</h1>
          <h1 className="font-semibold text-2xl text-[#10ff2f] sm:text-5xl lg:text-left">
            {" "}
            20% OFF
          </h1>
          ...
          <button className="mx-auto mt-5 w-1/2 bg-amber-400 px-3 py-1 text-black duration-100 hover:bg-yellow-300 lg:mx-0 lg:h-10 lg:w-2/12 lg:px-10 rounded-xl">
            Order Now
          </button>
        </div>
      </div>
